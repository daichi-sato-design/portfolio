                ...
                <li className="detail__block__item">
                  ...
                  <div className="body">
                    <p className="body__txt">
                      投稿内容に「テーマ」を設定し発信するSNSサービスです。投稿がカテゴライズされることで情報収集が容易になりブログのような専門性に特化したSNSを目指しました。手軽に専門的な発信を「テーマ」で検索できることでアカウントの信憑性も可視化できるので「名刺のようなSNS」になることをイメージし制作しました。
                    </p>
                  </div>
                </li>
                <li className="detail__block__item">
                  ...
                  <div className="body">
                    <p className="body__txt">
                      現状のSNSでは、さまざまな発信が一つのアカウントから投稿されており投稿を読み直すとき、気になる情報が興味のない投稿によって埋もれてしまい見つけられない問題があります。Flagupでは、一つのアカウントでも「テーマ」を設定し発信するのでアカウントの「得意分野」や「専門性」が可視化されるようになります。昨今見られるインフルエンサーの多すぎる肩書などの信憑性に関する不安を払拭できるSNSを目指し制作しました。
                    </p>
                  </div>
                </li>
                <li className="detail__block__item">
                  ...
                  <div className="body">
                    <p className="body__txt">
                      「フォロー」や「いいね」、「プロフィール」などのSNSの核となる既存の機能は受け継ぎ、投稿に「テーマ」という概念を新しく加えました。「テーマ」について継続的に発信していることが外部から数値で認知することができるようになり、信憑性を確かめる指標となります。また、「テーマ」に「ジャンル」を指定することができ、新規ユーザーは「ジャンル」から検索をすることで気になる「テーマ」を見つけるやすくなるように取り組みました。
                    </p>
                  </div>
                </li>
                <li className="detail__block__item">
