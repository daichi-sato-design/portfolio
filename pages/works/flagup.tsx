            ...
            <div className="detail">
              ...
              <ul className="detail__block">
                ...
                <li className="detail__block__item">
                  ...
                  <div className="body">
                    <p className="body__txt">
                      「フォロー」や「いいね」、「プロフィール」などのSNSの核となる既存の機能は受け継ぎ、投稿に「テーマ」という概念を新しく加えました。「テーマ」について継続的に発信していることが外部から数値で視認することができるようになり、信憑性を確かめる指標となります。また、「テーマ」に「ジャンル」を指定することができ、新規ユーザーは「ジャンル」から検索をすることで気になる「テーマ」を見つけやすくなるように取り組みました。
                    </p>
                  </div>
                </li>
                <li className="detail__block__item">
