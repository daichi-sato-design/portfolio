                ...
                <li className="detail__block__item">
                  ...
                  <div className="body">
                    <p className="body__txt">
                      SNSの投稿がテーマ別にカテゴライズされることで収集が容易になりブログのように気がつくと更新されているストレスもなくなり、手軽に専門的な発信をテーマ別に検索・収集できるSNSを目指し制作しました。
                    </p>
                  </div>
                </li>
                <li className="detail__block__item">
                  ...
                  <div className="body">
                    <p className="body__txt">
                      SNSのさまざまな発信が一つのアカウントから投稿され読み直すとき、気になる情報が興味のない投稿によって隠され見つからない状態を解決するためにテーマ別に投稿できるようにしました。一つのアカウントでさまざまなテーマの発信・閲覧できるようになるので昨今見られるインフルエンサーの多すぎる肩書の信憑性を確かめられるSNSになると考えています。
                    </p>
                  </div>
                </li>
                <li className="detail__block__item">
                  ...
                  <div className="body">
                    <p className="body__txt">
                      「フォロー」や「いいね」、「プロフィール」などのSNSの核となる既存の機能は受け継ぎ、投稿に「テーマ」という概念を新しく加えました。「テーマ」について継続的に発信しているアカウントは外部から数値で認知することができ、信憑性を確かめる指標となります。また、「テーマ」に「ジャンル」を指定することができ、新規ユーザーは「ジャンル」から検索をかけ気になる「テーマ」を見つけるきっかけ作りも取り組みました。
                    </p>
                  </div>
                </li>
                <li className="detail__block__item">
