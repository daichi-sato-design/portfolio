            ...
            <div className="detail">
              ...
              <ul className="detail__block">
                ...
                <li className="detail__block__item">
                  ...
                  <div className="body">
                    <p className="body__txt">
                      リアルタイムに特化するため募集は「3分・5分・10分」に制限し、募集中のカードにカウントダウンを表示しました。また、ユーザーはマッチングまでの早さを目的に当サービスを利用すると考えたため、募集をかけるフォームはチェックリストやセレクトボックスを多用し簡単に募集ができるようにしました。募集に申し込む手続きも確認画面を認証するだけの手軽さにし設計しています。
                    </p>
                  </div>
                </li>
                <li className="detail__block__item">
